...
import type { CollapseExpansionState, CollapseRevealRange } from './collapseState';
import type { CollapsedRowBlockDescriptor } from './collapsibleRows';
import { getWorkbookSplitRowNumber } from './workbookNavigation';
