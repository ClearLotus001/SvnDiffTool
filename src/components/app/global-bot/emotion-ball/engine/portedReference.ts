export const PORTED_HEAD_CENTER = 114.2705;
export const PORTED_EYE_HALF = 21;
export const PORTED_EYE_RINGS = [
  [
    [
      [130.36, 45.98],
      [132.71, 46.19],
...
export const PORTED_BODY_SHAPES = {
  blob: {
    ring: [
      [228.54, 114.27],
      [228.29, 121.74],
...
export const PORTED_EMOTIONS = [
  ...
  },
  {
    ...
    eyes: { left: { lookX: -4, lookY: 2 }, right: { lookX: 5, lookY: -1 } },
    anims: [
  ...
  },
  {
    ...
    en: {
      name: "Down",
      desc: "Drowsy rings rotate slowly, eyes sinking with a downcast gaze",
    },
    transition: 820,
    pool: [4, 13, 22],
    poolMs: [4000, 7000],
  ...
  },
  {
    ...
    en: {
      name: "Done",
      desc: "Smiling rings, a celebratory ribbon spin and a burst of confetti",
    },
    transition: 240,
    pool: [2, 8, 17],
    poolMs: [1400, 2600],
  ...
  },
  {
    ...
    eyes: { left: { y: -3, rotate: -6 }, right: { y: 4, rotate: 8 } },
    anims: [
      {
        target: "eyes",
        prop: "lookX",
  ...
  },
  {
    ...
    en: {
      name: "Powering Off",
      desc: "Closing rings shrink to half-closed and quietly freeze",
    },
    transition: 280,
    gaze: false,
    pool: [13, 22],
