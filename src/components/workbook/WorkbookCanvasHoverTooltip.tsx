...
const WorkbookCanvasHoverTooltip = memo(({
  ...
  return createPortal(
    <div
      ...
      <div
        ref={bubbleRef}
        className="svn-tooltip-surface relative max-w-[360px] px-2.5 py-2 rounded-xl font-ui text-app-xs leading-[1.35] shadow-[0_14px_30px_rgba(0,0,0,0.12)] border border-border-default text-text-title glass"
        style={{
